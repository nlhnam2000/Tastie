        ...
        <View style={[styles.sectionWrapper, {marginTop: 20}]}>
          ...
          <View style={[styles.flexRow, {padding: 15}]}>
            <TouchableOpacity
              ...
              style={[
                styles.typeButton,
                {backgroundColor: selectedType === 'Home' ? 'black' : '#e6e6e6'},
              ]}>
              <Text style={[styles.heading2, {color: selectedType === 'Home' ? 'white' : 'black'}]}>
                Home
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              style={[
                styles.typeButton,
                {backgroundColor: selectedType === 'Work' ? 'black' : '#e6e6e6'},
              ]}>
              <Text style={[styles.heading2, {color: selectedType === 'Work' ? 'white' : 'black'}]}>
                Work
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              style={[
                styles.typeButton,
                {backgroundColor: selectedType === 'Other' ? 'black' : '#e6e6e6'},
              ]}>
              <Text
                style={[styles.heading2, {color: selectedType === 'Other' ? 'white' : 'black'}]}>
                Other
              </Text>
            </TouchableOpacity>
          </View>
